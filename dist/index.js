...
var ColorInput = function (_a) {
    ...
    return (jsxRuntime.jsx(material.TextField, { label: "Hex Color", value: value, onChange: function (e) { return onChange(e.target.value); }, fullWidth: true, margin: "normal", error: !isValid, helperText: !isValid ? "Invalid hex color" : "", InputProps: {
            endAdornment: onEyedropper && (jsxRuntime.jsx(material.InputAdornment, __assign({ position: "end" }, { children: jsxRuntime.jsx(material.IconButton, __assign({ onClick: onEyedropper, size: "small" }, { children: jsxRuntime.jsx(iconsMaterial.Colorize, {}) })) }))),
        } }));
};
...
var ColorSlider = function (_a) {
    ...
    return (jsxRuntime.jsxs(material.Box, __assign({ sx: { mb: 2 } }, { children: [jsxRuntime.jsxs(material.Typography, __assign({ variant: "body2" }, { children: [label, ": ", value] })), jsxRuntime.jsx(material.Slider, { value: value, onChange: function (_, newValue) { return onChange(newValue); }, min: min, max: max, step: step, sx: {
                    '& .MuiSlider-thumb': {
...
var ColorSwatch = function (_a) {
    ...
    return (jsxRuntime.jsx(material.Box, { onClick: onClick, sx: {
            width: 30,
            height: 30,
            backgroundColor: color,
            borderRadius: 1,
...
var useColorState = function (initialColor, format) {
    ...
    var _a = react.useState(initialColor), hex = _a[0], setHex = _a[1];
    var _b = react.useState({ r: 0, g: 0, b: 0 }), rgb = _b[0], setRgb = _b[1];
    var _c = react.useState({ h: 0, s: 0, l: 0 }), hsl = _c[0], setHsl = _c[1];
    var _d = react.useState(1), opacity = _d[0], setOpacity = _d[1];
    var _e = react.useState(initialColor), outputColor = _e[0], setOutputColor = _e[1];
...
var PickerButton = styles.styled(material.Button)(function (_a) {
    var theme = _a.theme;
    return ({
        width: 50,
        height: 50,
...
var PickerPopover = styles.styled(material.Popover)(function (_a) {
    var theme = _a.theme;
    return ({
        '& .MuiPaper-root': {
...
var ColorPreview = styles.styled(material.Box)(function (_a) {
    var theme = _a.theme;
    return ({
        width: '100%',
        height: 60,
...
var ColorWheelCanvas = styles.styled('canvas')(function (_a) {
    var theme = _a.theme;
    return ({
        width: '100%',
        height: 200,
...
var ColorWheel = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(PickerButton, { "aria-describedby": id, onClick: handleClick, disabled: disabled, sx: __assign({ backgroundColor: color }, SizeStyles[size]) }), jsxRuntime.jsxs(PickerPopover, __assign({ id: id, open: open, anchorEl: anchorEl, onClose: handleClose, anchorOrigin: {
                    vertical: 'bottom',
                    horizontal: 'left',
                } }, { children: [jsxRuntime.jsx(material.Typography, __assign({ variant: "subtitle1", gutterBottom: true }, { children: label })), jsxRuntime.jsx(ColorPreview, { sx: { backgroundColor: color } }), jsxRuntime.jsx(ColorWheelCanvas, { ref: canvasRef, onClick: handleCanvasClick }), jsxRuntime.jsx(ColorInput, { value: hex, onChange: handleHexChange, isValid: isValidHex(hex), onEyedropper: showEyedropper ? handleEyedropper : undefined }), jsxRuntime.jsx(ColorSlider, { label: "Hue", value: hsl.h, min: 0, max: 360, onChange: handleHueChange, color: theme.palette.primary.main }), jsxRuntime.jsx(ColorSlider, { label: "Saturation", value: hsl.s, min: 0, max: 100, onChange: handleSaturationChange, color: theme.palette.secondary.main }), jsxRuntime.jsx(ColorSlider, { label: "Lightness", value: hsl.l, min: 0, max: 100, onChange: handleLightnessChange, color: theme.palette.success.main }), showOpacity && (jsxRuntime.jsx(ColorSlider, { label: "Opacity", value: opacity, min: 0, max: 1, step: 0.01, onChange: handleOpacityChange, color: theme.palette.grey[500] })), jsxRuntime.jsxs(material.Typography, __assign({ variant: "body2", gutterBottom: true }, { children: ["Output (", format, "): ", outputColor] })), jsxRuntime.jsx(material.Typography, __assign({ variant: "body2", gutterBottom: true, sx: { mt: 2 } }, { children: "Preset Colors:" })), jsxRuntime.jsx(material.Grid, __assign({ container: true, spacing: 1 }, { children: presetColors.map(function (swatch, index) { return (jsxRuntime.jsx(material.Grid, __assign({ item: true }, { children: jsxRuntime.jsx(ColorSwatch, { color: swatch, onClick: function () { return handlePresetClick(swatch); } }) }), index)); }) }))] }))] }));
};
